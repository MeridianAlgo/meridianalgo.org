...
const PublicToolsPage = lazy(() => import('./pages/PublicToolsPage'));
const FinancialNews = lazy(() => import('./pages/FinancialNews'));
const Tools = lazy(() => import('./pages/Tools'));
const CalculatorPage = lazy(() => import('./pages/CalculatorPage'));
const PublicTools = lazy(() => import('./pages/PublicTools'));
const PublicCalculatorPage = lazy(() => import('./pages/PublicCalculatorPage'));
        ...
        <HelmetProvider>
          ...
          <Suspense fallback={
            ...
            <Routes>
              ...
              {/* Public Financial Tools - No Auth Required */}
              <Route path="/tools" element={<PublicTools />} />
              <Route path="/calculator/:calculatorId" element={<PublicCalculatorPage />} />
              ...
              <Route path="/learning-tools" element={
                <ProtectedRoute>
                  <ToolsPage />
                </ProtectedRoute>
              } />

              {/* New Tools page with all calculators */}
              <Route path="/tools-center" element={
                <ProtectedRoute>
                  <Tools />
                </ProtectedRoute>
              } />
              ...
              <Route path="/tools/:calculatorId" element={
                <ProtectedRoute>
                  <CalculatorPage />
                </ProtectedRoute>
              } />
