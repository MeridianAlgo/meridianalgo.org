        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/MeridianAlgo/Website" className="bg-slate-800 hover:bg-blue-600 p-2 rounded-lg transition-all duration-300 hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://docs.meridianalgo.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:translate-x-1">Documentation</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:translate-x-1">Documentation</a></li>
              <li><a href="#" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:translate-x-1">Tutorials</a></li>
              <li><a href="#" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:translate-x-1">Community Forum</a></li>
        ...
        <div className="mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-105">Privacy Policy</a>
              <a href="#" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-105">Terms of Service</a>
