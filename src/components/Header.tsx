      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link to="/documentation" className="text-white/80 hover:text-white px-3 py-2 text-sm font-medium transition-all duration-300 hover:scale-105">
              Documentation
            </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-white/10 bg-black/90 backdrop-blur-md">
              ...
              <Link to="/documentation" className="block text-white/80 hover:text-white px-3 py-2 text-base font-medium transition-colors duration-300">
                Documentation
              </Link>
