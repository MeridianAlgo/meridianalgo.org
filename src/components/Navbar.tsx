...
const NAV_LINKS = [
  ...
  { name: 'Documentation', to: 'http://localhost:3000', external: true },
          ...
          <React.Fragment key={link.name}>
            ...
            {link.name === 'Documentation' ? (
              <button
                ...
                className="text-white text-sm font-semibold tracking-widest hover:text-blue-400 transition-colors duration-200 uppercase font-mono px-1 focus:outline-none bg-transparent"
