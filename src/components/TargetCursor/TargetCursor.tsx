...
const TargetCursor = ({
    ...
    const cornersRef = useRef<NodeList | null>(null);
    ...
    useEffect(() => {
        ...
        const scrollHandler = () => {
            ...
            const isStillOverTarget =
                elementUnderMouse &&
                (elementUnderMouse === activeTarget || (elementUnderMouse instanceof HTMLElement && elementUnderMouse.closest(targetSelector) === activeTarget));
