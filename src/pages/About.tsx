...
const About = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black pt-24">
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-orange-400 mb-4">Our Approach</h2>
      ...
      {/* Gradient Divider */}
      <div className="w-full h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent my-12"></div>
      
      {/* What Sets Us Apart Section */}
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-orange-400 mb-4">What Sets Us Apart</h2>
            <div className="w-24 h-1 bg-orange-400 mx-auto"></div>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-orange-400 mb-6">Our Vision</h2>
          <div className="w-24 h-1 bg-orange-400 mx-auto mb-8"></div>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-orange-400 mb-4">Our Team</h2>
            <div className="w-24 h-1 bg-orange-400 mx-auto"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              'Ishaan Manoor', 'Dennis Talpa', 'Daniel Dimov', 'Ethan Hsu', 'Likhit (Siva) Reddy', 'Amogh Natarajan', 'Ibrahim Arif', 'Ameen Baig', 'Kaushal Pratury', 'Tanish Patel'
            ].map((name) => (
              <div key={name} className="bg-gray-900/70 p-6 rounded-2xl border border-gray-800 hover:border-orange-400/40 transition-colors text-center">
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-orange-400 mb-4">Team Structure</h2>
            <div className="w-24 h-1 bg-orange-400 mx-auto"></div>
          </div>
