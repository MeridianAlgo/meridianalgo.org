        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
            <h1 className="text-5xl md:text-8xl font-display font-bold mb-6 leading-none uppercase tracking-tight text-white mt-6">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-amber-300">Us</span>
            </h1>
          </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            <div className="inline-flex items-center gap-2 text-gray-400 text-sm bg-white/5 px-6 py-3 rounded-full border border-white/10">
              <Globe className="w-4 h-4 text-orange-300/70" />
        ...
        <section className="relative py-32 overflow-hidden bg-black">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="max-w-7xl mx-auto px-6 h-full relative">
              <div className="absolute top-0 left-6 md:left-24 w-px h-full bg-orange-300/15" />
              <div className="absolute top-0 right-6 md:right-24 w-px h-full bg-orange-300/15" />
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h2 className="text-3xl md:text-6xl font-display font-bold text-white mb-10 tracking-tight uppercase leading-tight mt-6">
              Finance for <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-amber-300">Everyone</span>
            </h2>
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-display font-bold text-white tracking-tight uppercase leading-tight mt-6">
                What Sets Us <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-amber-300">Apart</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              {[
                {
                  icon: <BookOpen className="w-6 h-6 text-orange-300/80" />,
                  title: 'Practical Education',
                  desc: 'Financial newsletters, tutorials, and tools tailored for everyday users — not just Wall Street insiders.',
                },
                {
                  icon: <Zap className="w-6 h-6 text-orange-300/80" />,
                ...
                {
                  icon: <Globe className="w-6 h-6 text-orange-300/80" />,
                  title: 'Global Impact',
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white mb-4 tracking-tight uppercase group-hover:text-orange-300/90 transition-colors duration-200">{item.title}</h3>
        ...
        <section className="relative py-32 bg-black overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="max-w-7xl mx-auto px-6 h-full relative">
              <div className="absolute top-0 left-6 md:left-24 w-px h-full bg-orange-300/15" />
              <div className="absolute top-0 right-6 md:right-24 w-px h-full bg-orange-300/15" />
              <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-12rem)] h-px bg-orange-300/15" />
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h2 className="text-3xl md:text-6xl font-display font-bold text-white mb-8 tracking-tight uppercase leading-tight mt-6">
              A World Without <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-amber-300 pr-1">Barriers</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/newsletters"
                className="px-8 py-4 border border-orange-300/50 text-orange-300 hover:bg-orange-400 hover:text-white hover:border-orange-400 rounded-xl font-bold text-base transition-all duration-300 active:scale-95 uppercase tracking-wider"
              >
                Read Newsletter
              </Link>
            </div>
