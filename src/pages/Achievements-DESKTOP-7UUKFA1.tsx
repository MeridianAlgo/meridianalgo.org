            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                  <div className="mb-6 md:mb-0">
                    <h1 className="text-3xl md:text-4xl font-display font-bold mb-2">
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Your Achievements</span>
                    </h1>
                    <p className="text-lg text-gray-300">
                      Track your progress and earn rewards on your financial journey
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                    ...
                    <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-4 flex-1">
                      ...
                      <div className="flex items-end justify-between">
                        <h3 className="text-2xl font-bold text-white">{earnedAchievements.length}/{achievements.length}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredAchievements.map((achievement) => (
                  <div
                    key={achievement.id}
                    className={`bg-gray-800 rounded-2xl p-6 border transition-all duration-300 ${achievement.earned
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <span className={`text-xs px-2 py-1 rounded-full font-medium ${achievement.earned
                        ? 'bg-orange-500/20 text-orange-400'
                        : 'bg-gray-700 text-gray-500'
                        }`}>
