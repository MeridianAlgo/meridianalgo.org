...
import { 
  ...
  LogOut, Menu, ChevronLeft, Trophy, Flame, Calendar, Zap, 
  FileText, Shield, Building, Lightbulb, Brain, Clock, Moon,
  BarChart, Lock, CheckCircle, User } from 'lucide-react';
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gray-800 border-r border-gray-700 transition-all duration-300 flex flex-col fixed h-full z-10`}>
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center justify-between">
            <Link to="/" className={`flex items-center ${!sidebarOpen && 'justify-center'}`}>
              ...
              {sidebarOpen && (
                <span className="ml-3 text-xl font-bold text-white">Achievements</span>
              )}
            </Link>
            <button
        ...
        <nav className="flex-1 p-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center px-3 py-2 bg-yellow-600 text-white rounded-lg">
              <Trophy className="w-5 h-5" />
              {sidebarOpen && <span className="ml-3 font-medium">Achievements</span>}
            </div>
            <Link
              to="/profile"
              className="flex items-center px-3 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors"
          ...
          <div className={`flex items-center ${!sidebarOpen && 'justify-center'}`}>
            ...
            {sidebarOpen && (
              <div className="ml-3 flex-1">
                ...
                <p className="text-xs text-gray-400">{totalPoints} achievement points</p>
              </div>
            )}
          </div>
          {sidebarOpen && (
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-white">
                Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">Achievements</span>
              </h1>
