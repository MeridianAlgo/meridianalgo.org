        ...
        <section className="py-20 min-h-screen flex items-center justify-center bg-transparent">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="rounded-3xl p-12 bg-transparent">
              <div className="bg-gradient-to-r from-orange-500 to-orange-300 rounded-full p-6 w-fit mx-auto mb-8">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-400/20 to-yellow-500/20 rounded-2xl mb-8">
              <Mail className="w-10 h-10 text-orange-300" />
            </div>
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 leading-tight">
              Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Touch</span>
            </h1>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="text-center mb-16">
                <span className="text-xs uppercase tracking-widest text-orange-300 font-mono mb-6 inline-block bg-orange-300/10 px-4 py-2 rounded-full">Contact Information</span>
                <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-6 leading-tight">
                  Let's <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Connect</span>
                </h2>
                <div className="w-16 h-0.5 bg-gradient-to-r from-orange-300 to-yellow-400 mx-auto"></div>
              </div>

              <div className="space-y-6 mb-12">
                <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 hover:border-orange-300/30 transition-all duration-300 p-6 rounded-2xl">
                ...
                <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 hover:border-orange-300/30 transition-all duration-300 p-6 rounded-2xl">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/MeridianAlgo" className="text-orange-300 hover:text-orange-300 transition-colors duration-300">
              ...
              <div className="mb-12">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="bg-gray-800/50 hover:bg-orange-400 p-3 rounded-xl transition-all duration-300 hover:scale-110 border border-gray-700/50 hover:border-orange-300/50"
                  >
              ...
              <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 text-gray-300 hover:text-orange-300 transition-colors duration-300">
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 rounded-3xl p-10">
              <div className="text-center mb-8">
                <span className="text-xs uppercase tracking-widest text-orange-300 font-mono mb-4 inline-block bg-orange-300/10 px-4 py-2 rounded-full">Contact Form</span>
                <h2 className="text-2xl font-bold text-white mb-4">Send us a Message</h2>
                <div className="w-12 h-0.5 bg-gradient-to-r from-orange-300 to-yellow-400 mx-auto"></div>
              </div>
