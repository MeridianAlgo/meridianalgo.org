...
import { Mail, Github, MapPin, Send, Linkedin, Twitter } from 'lucide-react';
            ...
            <div>
              ...
              <div className="mb-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    className="bg-slate-800 hover:bg-blue-600 p-3 rounded-xl transition-all duration-300 hover:scale-110"
                  >
                    <Twitter className="w-6 h-6 text-slate-400 hover:text-white" />
                  </a>
                  <a 
              ...
              <div className="rounded-2xl p-8 bg-transparent">
                ...
                <div className="space-y-3">
                  ...
                  <span className="font-inter font-light">Support our democratization mission</span>
                </div>
              </div>
            </div>
            {/* Contact Form */}
