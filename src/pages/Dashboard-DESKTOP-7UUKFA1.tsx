    ...
    <div className="min-h-screen bg-black text-white pt-24">
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-blue-400/30 rounded-2xl p-8 mb-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Financial News Hub</h2>
              <Link 
                to="/financial-news"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <Link 
                to="/financial-news?category=Markets"
              ...
              >
                ...
                <p className="text-gray-400 text-sm">Latest stock market updates</p>
              </Link>

              <Link 
                to="/financial-news?category=Investing"
                className="bg-black/40 hover:bg-black/60 border border-gray-700 hover:border-purple-400/50 rounded-xl p-6 transition-all group"
              >
                <Target className="w-8 h-8 text-purple-400 mb-3 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Investing</h3>
                <p className="text-gray-400 text-sm">Investment strategies and tips</p>
              </Link>

              <Link 
                to="/financial-news?category=Personal Finance"
              ...
              >
                <Star className="w-8 h-8 text-green-400 mb-3 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Personal Finance</h3>
                <p className="text-gray-400 text-sm">Money management insights</p>
              </Link>
            </div>
          </div>
