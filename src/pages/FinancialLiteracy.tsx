...
const FinancialLiteracy = () => {
  ...
  const lessons = useCountUp(50);
  const modulesCount = useCountUp(10);
  const tools = useCountUp(25);
          ...
          <div className="text-center mb-16">
            ...
            {!isAuthenticated && (
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  to="/login"
                  className="px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg flex items-center gap-2"
                >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div ref={lessons.elementRef}>
              ...
              <div className="text-gray-300 text-lg">Interactive Lessons</div>
            </div>
            <div ref={modulesCount.elementRef}>
              <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">
                {modulesCount.count}+
              </div>
              <div className="text-gray-300 text-lg">Learning Modules</div>
            </div>
            <div ref={tools.elementRef}>
              <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">
                {tools.count}+
              </div>
              <div className="text-gray-300 text-lg">Financial Tools</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent mb-2">
                100%
              </div>
              <div className="text-gray-300 text-lg">Free & Open Source</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {learningModules.map((module, index) => (
              <div
                key={module.id}
                className="group relative bg-gray-900/50 rounded-2xl p-8 border border-gray-800 hover:border-orange-400/40 transition-all duration-300 hover:scale-[1.02] flex flex-col"
              >
                ...
                <p className="text-gray-400 mb-6 text-sm leading-relaxed flex-grow">{module.description}</p>
                ...
                {isAuthenticated ? (
                  ...
                  <Link
                    to="/login"
                    className="inline-flex items-center justify-center w-full px-6 py-3 border-2 border-orange-400 text-orange-400 hover:bg-orange-500 hover:text-white hover:border-orange-500 rounded-xl font-medium transition-all duration-300 whitespace-nowrap"
                  >
