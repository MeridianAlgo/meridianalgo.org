        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
              Master essential financial concepts with practical, globally-applicable guidance. Build confidence in budgeting, saving, investing, and planning for your financial future.
            </p>
          </div>
          ...
          {!isAuthenticated && (
            <div className="max-w-2xl mx-auto mb-12">
              <div className="bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-400/30 rounded-2xl p-8 text-center">
                <LogIn className="w-12 h-12 text-orange-400 mx-auto mb-4" />
                <h3 className="text-xl font-bold text-white mb-3">
                  🎉 Join Free to Track Your Progress!
                </h3>
                <p className="text-gray-300 mb-6">
                  Sign up for free to save your learning progress, earn achievements, and get personalized recommendations. No credit card required!
                </p>
                <button
                  onClick={() => setShowAuthModal(true)}
                  className="bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 hover:transform hover:scale-[1.02]"
                >
                  Sign Up Free
                </button>
              </div>
