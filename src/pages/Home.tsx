        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl md:text-7xl font-display font-bold mb-6 text-white text-shadow-glow tracking-tight uppercase">
              Chart Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Ascent</span>
            </h1>
          </div>
          ...
          <div className="animate-fade-in-up flex flex-col sm:flex-row gap-5 justify-center items-center" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            ...
            <Link
              to="/opensource"
              className="px-8 py-4 border border-orange-300/50 text-orange-300 hover:bg-orange-400 hover:text-white hover:border-orange-400 rounded-xl font-bold text-base transition-all duration-300 backdrop-blur-sm active:scale-95 shadow-lg"
            >
              Explore Open Source
            </Link>
          </div>
      ...
      <div className="w-full relative z-10">
        ...
        <section id="purpose" className="relative py-32 overflow-hidden bg-black/80 backdrop-blur-sm">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="absolute top-16 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-12rem)] h-px bg-orange-300/15"></div>

            <div className="absolute -top-[152px] left-1/2 -translate-x-1/2 w-px h-[217px] bg-orange-300/15"></div>

            {/* Edge Vertical Lines (Frame) */}
            <div className="absolute top-16 left-6 md:left-24 w-px h-[698px] bg-orange-300/15"></div>
            <div className="absolute top-16 right-6 md:right-24 w-px h-[802px] bg-orange-300/15"></div>

            <div className="relative text-center space-y-6 pt-24">
              <div className="mb-16 max-w-3xl mx-auto">
                <span className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-orange-300 font-mono mb-6 inline-block bg-black/80 px-4 py-2 rounded-full border border-orange-300/30 backdrop-blur-sm">Our Purpose</span>
                <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 tracking-tight uppercase leading-tight">
                  Building the <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Future of Finance</span>
                </h2>
              ...
              <div className="relative grid md:grid-cols-3 gap-6 max-w-5xl mx-auto pb-12">
                {[
                  ...
                  <Link key={i} to={box.link} className="group bg-black/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 hover:border-orange-300/40 transition-all duration-300 hover:-translate-y-1 flex flex-col items-start text-left shadow-2xl z-20">
                    <div className="p-3 bg-orange-400/10 rounded-xl mb-6 group-hover:bg-orange-400/20 transition-colors ring-1 ring-orange-400/20">
                      {box.icon && React.cloneElement(box.icon as React.ReactElement, { className: "w-6 h-6 text-orange-300" })}
                    </div>
                    <h3 className="text-xl font-bold text-white mb-3 tracking-tight group-hover:text-orange-300 transition-colors">{box.title}</h3>
        ...
        <section className="relative py-32 overflow-hidden bg-black/80 backdrop-blur-sm">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="max-w-7xl mx-auto px-6 h-full relative">
              <div className="absolute top-0 left-6 md:left-24 w-px h-[calc(100%+8rem)] bg-orange-300/15 z-0"></div>
              <div className="absolute top-0 right-6 md:right-24 w-px h-[calc(100%+8rem)] bg-orange-300/15 z-0"></div>
            </div>
          </div>

          <div className="relative z-10 text-center space-y-6 w-full">
            <div className="mb-12 max-w-3xl mx-auto px-6">
              <span className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-orange-300 font-mono mb-6 inline-block bg-black/80 px-4 py-2 rounded-full border border-orange-300/30 backdrop-blur-sm">Our Code</span>
              <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 tracking-tight uppercase leading-tight">
                For the <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Community</span>
              </h2>
              <p className="text-lg text-gray-400 font-light max-w-2xl mx-auto leading-relaxed">
            ...
            >
              {[...OPEN_SOURCE_PROJECTS, ...OPEN_SOURCE_PROJECTS, ...OPEN_SOURCE_PROJECTS].map((project, index) => (
                <div
                  ...
                  className={`flex-none w-[400px] bg-black/80 backdrop-blur-xl border border-white/10 hover:border-orange-300/40 p-8 rounded-[2rem] transition-all duration-500 group relative overflow-hidden flex flex-col shadow-2xl`}
                >
                  <div className="flex items-center space-x-5 mb-8 relative z-10">
                    <div className="p-4 bg-gray-900 rounded-xl ring-1 ring-white/10 group-hover:ring-orange-300/40 transition-all duration-300">
                      {project.icon}
                    </div>
                    <h3 className="text-xl font-bold text-white group-hover:text-orange-300 transition-colors tracking-tight uppercase leading-none">{project.title}</h3>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-8 relative z-10">
                    {project.tags.map((tag, tagIndex) => (
                      <span key={tagIndex} className="text-[10px] font-mono uppercase tracking-wider px-3 py-1.5 bg-white/5 text-gray-300 rounded-lg border border-white/10 group-hover:border-orange-300/20 transition-colors">
                        {tag}
                      </span>
                    ))}
                  </div>
                  <a
                    ...
                    className="mt-auto w-full inline-flex items-center justify-center px-6 py-3 bg-orange-400/5 hover:bg-orange-400 text-white rounded-xl font-bold transition-all duration-300 border border-orange-300/10 group-hover:border-transparent shadow-lg uppercase tracking-widest text-[10px]"
                  >
            ...
            <div className="mt-8">
              <Link to="/opensource" className="px-6 py-3 rounded-xl border border-orange-300/40 text-orange-300 hover:bg-orange-400 hover:text-white transition-all duration-300 font-bold whitespace-nowrap text-xs uppercase tracking-[0.2em] shadow-lg inline-block">
        ...
        <section className="py-32 bg-black/80 backdrop-blur-sm relative">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
            <span className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-orange-300 font-mono mb-6 inline-block bg-black/80 px-4 py-2 rounded-full border border-orange-300/30 backdrop-blur-sm">Core Values</span>
            <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 tracking-tight uppercase leading-tight">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Standard</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              {FEATURES.map((feature, index) => (
                <div key={index} className="bg-gray-900/20 backdrop-blur-sm rounded-[2rem] p-10 border border-white/5 transition-all duration-500 hover:border-orange-300/40 group relative overflow-hidden z-20">
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-orange-300/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  <h3 className="text-xl font-bold text-white mb-6 tracking-tight group-hover:text-orange-300 transition-colors uppercase font-display leading-tight">{feature.title}</h3>
        ...
        <section className="py-32 relative bg-black/80 backdrop-blur-sm">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="max-w-7xl mx-auto px-6 h-full relative">
              <div className="absolute top-0 left-6 md:left-24 w-px h-full bg-orange-300/15 z-0"></div>
              <div className="absolute top-0 right-6 md:right-24 w-px h-full bg-orange-300/15 z-0"></div>
              {/* Bottom Cap Line */}
              <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-12rem)] h-px bg-orange-300/15 z-0"></div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-12 tracking-tight uppercase leading-tight">
              About Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">Codestack</span>
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-16">
              {CODESTACK.map((tech, i) => (
                <div key={i} className="flex flex-col items-center justify-center p-6 bg-gray-900/50 rounded-2xl border border-white/5 hover:border-orange-300/30 transition-all hover:-translate-y-1">
