...
const Learning = () => {
  ...
  const { user, isAuthenticated, updateProgress, logout } = useAuth();
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 text-white">
      <Sidebar
      ...
      <div className={`flex-1 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${sidebarOpen ? 'ml-72' : 'ml-20'}`}>
        <div className="pt-16">
          {/* Header */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  <p className="text-gray-400">Welcome back, <span className="text-blue-400 font-medium">{firstName}</span>!</p>
                </div>
              </div>

              {/* Hero Section */}
              <div className="mb-8 bg-gradient-to-r from-gray-800/70 to-gray-900/70 border border-gray-700/50 rounded-xl p-6 shadow-lg">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                  <div className="mb-6 md:mb-0">
                    ...
                    <p className="text-lg text-gray-300">
                      Master financial literacy with our interactive curriculum
                    </p>
                  </div>
                  
                  {/* Stats Card */}
                  <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                    <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-4 flex-1">
                      <p className="text-sm text-gray-400 mb-1">Progress</p>
                      <div className="flex items-end justify-between">
                        <h3 className="text-2xl font-bold text-white">{Math.round(progressPercentage)}%</h3>
                    ...
                    <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-4 flex-1">
                      ...
                      <div className="flex items-end justify-between">
                        <h3 className="text-2xl font-bold text-white">{completedCount}/{totalConcepts}</h3>
                  ...
                  {sections.map((section) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs px-2 py-0.5 rounded-full bg-gray-700/70">
                          {sectionCompletedConcepts}/{section.concepts.length}
                        </span>
                      </button>
                    );
                  })}
              ...
              <div className="space-y-6">
                {sections.map((section) => {
                  ...
                  return isExpanded && (
                    <div key={section.id} className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
                        ...
                        return (
                            <div key={conceptIndex} className="bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden hover:shadow-md hover:border-gray-600 transition-all">
                              <div className="p-4">
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    <h4 className="text-lg font-semibold text-white">{concept.title}</h4>
                                    <p className="text-gray-300 text-sm mt-1">{concept.description}</p>
                                  </div>
                                  <button
                                    onClick={() => toggleConceptCompletion(conceptId)}
                                    className={`ml-3 flex items-center justify-center w-8 h-8 rounded-lg border transition-all ${
                                      isCompleted
                                ...
                                <div className="mt-4 space-y-4">
                                  ...
                                  <div>
                                    <h5 className="text-sm font-medium text-orange-400 mb-2 flex items-center">
                                      <div className="w-1 h-4 bg-orange-400 rounded-full mr-2"></div>
                                      Action Items
                                    </h5>
                                    <ul className="space-y-1.5 pl-3">
                                ...
                                {concept.globalTip && (
                                  <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                                    <h6 className="text-xs font-medium text-yellow-400 mb-1">💡 Global Perspective</h6>
