  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900/95 backdrop-blur-2xl border border-gray-800 rounded-3xl p-10 shadow-2xl animate-scaleIn">
          {/* Logo and Brand */}
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">MeridianAlgo</h1>
