          ...
          <div className="bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-400/30 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <p className="text-gray-400 text-sm">Jump back into your next lesson and keep your streak alive.</p>
              </Link>
              ...
              >
                <Newspaper className="w-8 h-8 text-blue-400 mb-3 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Financial News Hub</h3>
                <p className="text-gray-400 text-sm">Browse curated market headlines and filter by category to stay informed.</p>
              </Link>
              ...
              <Link 
                to="/achievements"
                className="bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-yellow-400/50 rounded-xl p-6 transition-all group"
              >
                <Award className="w-8 h-8 text-yellow-400 mb-3 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">View Achievements</h3>
                <p className="text-gray-400 text-sm">See the badges and milestones you’ve earned so far.</p>
              </Link>
            </div>
          </div>
        </div>
